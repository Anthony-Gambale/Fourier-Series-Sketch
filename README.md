...
This program takes any curve as input, and approximates it using rotating vectors of different frequencies and lengths using a complex-valued fourier series. It then re-constructs the curve by animating the tip-to-tail sum of these vectors.
